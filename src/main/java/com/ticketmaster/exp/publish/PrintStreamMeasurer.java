...
public class PrintStreamMeasurer extends StringConsumerMeasurer{
  ...
  public static final PrintStreamMeasurer DEFAULT = new PrintStreamMeasurer(
      System.out, new ConcurrentMapMatchCounter<String>());

  public PrintStreamMeasurer(PrintStream printStream, MatchCounter<String> matchCounter) {
    super(printStream::println, matchCounter);
  }
}
